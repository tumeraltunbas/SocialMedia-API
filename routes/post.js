...
import { checkPostExists, checkProfileAccess, checkPostBelongsToBlockedUser } from "../middlewares/database/db.query.js";
...
router.get("/:username/:postId", [isAuth, checkPostExists, checkPostBelongsToBlockedUser, checkProfileAccess], getPostById);
