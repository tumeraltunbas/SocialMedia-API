...
import { checkPostExists, checkCommentExists, checkPostBelongsToUser, checkProfileAccess} from "../middlewares/database/db.query.js";
...
router.put("/:username/:postId/:commentId", [checkProfileAccess, checkCommentExists, getCommentOwnerAccess], updateComment);
