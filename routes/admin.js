...
import { getAllUsers, getAllPosts, getUserById, blockUserByAdmin, unblockUserByAdmin, assignAdminRole, undoAdminRole, getAllVerifyRequests, getVerifyRequestById, concludeVerifyRequest } from "../controllers/admin.js";
...
router.post("/verify/request/:verifyRequestId/conclude", checkVerifyRequestExists, concludeVerifyRequest);
