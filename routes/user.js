...
import { uploadProfileImage, removeProfileImage, updateProfile, addPhoneNumber, changePhoneNumber, deletePhoneNumber, changeEmail,getFollowRequests, confirmFollowRequest, followUser, unfollowUser, getLikedPosts, getProfile, getFollowings, getFollowers, blockUser, unblockUser, getBlocks, unblockAll, getSavedPosts, makeAccountPrivate, makeAccountPublic} from "../controllers/user.js";
...
router.get("/profile/:username/likes", [checkUserExists, postQueryMiddleware, checkUserFollowing], getLikedPosts);
